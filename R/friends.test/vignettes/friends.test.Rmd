...
\code{friends.test} and \code{friends.test.bic} return a list of lists, the first level is the marker (rowname in the table), the second is the friend (colname) and the leave in a vector of the marker index in the initial table, the friend index and the rank of the friend. Sometimes, we need a matrix structure. 
